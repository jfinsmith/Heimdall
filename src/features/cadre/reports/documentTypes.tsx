...
export const DOCUMENT_TYPES: ReportType[] = [
  {
    ...
    document: {
      ...
      blocks: [
        ...
        { kind: 'clause', text: `3. PERMITTED MATERIALS. Nothing may be at the testing station except what the proctor issued or authorized for this examination. Issued scratch paper is examination material and must be returned.` },
        { kind: 'clause', text: `4. COMMUNICATION. Once administration begins, examinees may communicate only with the proctor — no speech, writing, gestures, or signals to anyone else. Raise a hand to speak privately with the proctor, who may clarify administration only, never examination content.` },
        { kind: 'clause', text: `5. INDIVIDUAL WORK. Keep your eyes on your own examination. Conduct a reasonable proctor would interpret as giving or receiving assistance — including positioning a screen or materials where another examinee can see them — is a violation.` },
        { kind: 'clause', text: `6. LEAVING THE ROOM. Leaving the room before submitting your examination ends it, unless the proctor expressly authorized the absence beforehand. An examinee who leaves for any reason may not re-enter until the proctor declares the session ended.` },
        { kind: 'clause', text: `7. TIME. When time is called, stop immediately and follow the proctor's completion instructions. Working after time is called is a violation.` },
        { kind: 'clause', text: `8. EXAMINATION SECURITY. All examination content remains academy property. Copying, photographing, transcribing, or removing it in any form is prohibited — as is discussing or disclosing it to anyone, including examinees who have not yet tested, before the academy officially releases it.` },
        ...
        { kind: 'clause', text: `11. ADMINISTRATION. The proctor's rulings on administration take effect immediately. Comply first; concerns may be raised with the Training Coordinator after the session and never excuse compliance during testing.` },
      ],
      ...
      signerLine: '',
      acknowledgment:
        'By signing below, I certify that I have read these Examination Rules (or had them read to me), had the opportunity to ask questions before the examination began, understand them, and agree to comply with them; that I have no extenuating circumstances preventing me from properly preparing for this examination and am prepared to take it at this time; and that I understand a violation may result in a failing grade and disciplinary action up to and including dismissal under the Academy Cadet Manual and applicable academy policy, and that examination content is confidential.',
