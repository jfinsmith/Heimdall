...
export const DOCUMENT_TYPES: ReportType[] = [
  {
    ...
    document: {
      ...
      blocks: [
        ...
        { kind: 'clause', text: `6. LEAVING THE ROOM. Leaving the room without the proctor's authorization ends your examination. An examinee the proctor permits to leave (for example, an emergency restroom break) may return only when the proctor grants re-entry.` },
