...
const CATALOG: Cat[] = [
  ...
  { id: 'firearms', name: 'Criminal Justice Firearms', code: 'CJK0040', hours: 80, hl: true, lead: 'handgun', slots: [{ role: 'assistant', count: 2, requiredQualificationKey: 'handgun' }, { role: 'safety_officer', count: 1, requiredQualificationKey: 'handgun' }] },
  { id: 'dt', name: 'Criminal Justice Defensive Tactics', code: 'CJK0051', hours: 80, hl: true, lead: 'dt', slots: [{ role: 'assistant', count: 2, requiredQualificationKey: 'dt' }, { role: 'role_player', count: 4, requiredQualificationKey: 'role_player' }, { role: 'safety_officer', count: 1, requiredQualificationKey: 'dt' }] },
  { id: 'dfsg', name: 'Dart-Firing Stun Gun (DFSG)', code: 'CJK0421', hours: 4, hl: true, lead: 'dt', slots: [{ role: 'safety_officer', count: 1, requiredQualificationKey: 'dt' }] },
  { id: 'vehicle-ops', name: 'Law Enforcement Vehicle Operations', code: 'CJK0020', hours: 48, hl: true, lead: 'vehicle_ops', slots: [{ role: 'assistant', count: 3, requiredQualificationKey: 'vehicle_ops' }, { role: 'safety_officer', count: 1, requiredQualificationKey: 'vehicle_ops' }] },
